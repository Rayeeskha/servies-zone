                        ...
                        @if(isset($modules[0]))
                           @foreach($modules as $modu)
                              <li>                           
                                 <h4 class="mb-1">
                                    <label>
                                    <input type="checkbox" value="{{ $modu->module_id }}" id="{{ $modu->module_id }}" name="module_id[]" onchange="onClickHandlerModule('{{ $modu->module_id }}')"/>
                                 ...
                                 <div class="input-checkset">
                                    <ul>
                                       <li>
                                          ...
                                          <input type="checkbox" name="{{ $modu->module_id }}_add"  onchange="onClickHandler('{{ $modu->module_id }}_add')" id="{{ $modu->module_id }}_add">
                                          <span class="checkmark"></span>
                                          </label>
                                       </li>                                  
                                       <li>
                                          <label class="inputcheck">Edit
                                          <input type="checkbox" name="{{ $modu->module_id }}_edit"  onchange="onClickHandler('{{ $modu->module_id }}_edit')" id="{{ $modu->module_id }}_edit">
                                          <span class="checkmark"></span>
                                          </label>
                                       </li>                                  
                                       <li>
                                          <label class="inputcheck">Change Status
                                          <input type="checkbox" name="{{ $modu->module_id }}_status"  onchange="onClickHandler('{{ $modu->module_id }}_status')" id="{{ $modu->module_id }}_status">
                                          <span class="checkmark"></span>
                                          </label>
                                       </li>
                                       <li>
                                          <label class="inputcheck">View
                                          <input type="checkbox" name="{{ $modu->module_id }}_view"  onchange="onClickHandler('{{ $modu->module_id }}_view')" id="{{ $modu->module_id }}_view">
                                          <span class="checkmark"></span>
                                          </label>
                                       </li> 
                                       <li>
                                          <label class="inputcheck">Delete
                                          <input type="checkbox" name="{{ $modu->module_id }}_delete"  onchange="onClickHandler('{{ $modu->module_id }}_delete')" id="{{ $modu->module_id }}_delete">
                                          <span class="checkmark"></span>
                                          </label>
                                       </li>                               
                                    </ul>
